...
function step(to, n) {
    ...
    if (n == 2) {
        ...
        term.write("Install wallpapers and sounds on the system.\r\n");
        term.write("Run: installWallpapers(modules.defaultSystem);\r\n");
        term.write("Run: installSfx(modules.defaultSystem);\r\n");
        ...
        term.write("Proceed to step(to, 21);\r\n");
    } else if (n == 21) {
        ...
        term.write("Proceed to step(to, 23);\r\n");
    } else if (n == 23) {
        ...
        term.write("Develop your system further, use step(to, 24);\r\n");
    } else if (n == 24) {
        ...
        term.write("Run: modules.fs.rm(modules.defaultSystem + \"/boot/16-wallpaper.js\");\r\n");
        term.write("Run: modules.fs.rm(modules.defaultSystem + \"/boot/16-sfxpack.js\");\r\n");
        term.write("Continue to step(to, 27);\r\n")
    } else if (n == 27) {
        term.write("Assign the dark theme to the root user.\r\n");
        term.write("Run: modules.fs.write(homedir + \"/.darkmode\", \"true\");\r\n");
        term.write("To continue (or keep in light mode) do step(to, 28);\r\n")
    } else if (n == 28) {
        ...
        term.write("Proceed to do step(to, 29);\r\n")
    } else if (n == 29) {
        ...
        term.write("To finish, do requireLogon(); step(to, 30); You can also boot into a working system with modules.restart(); or by closing this window.\r\n");
    } else if (n == 30) {
